...
export function WarehouseManager() {
  ...
  const loadSupplies = async () => {
    ...
    try {
      ...
      toast({ title: 'Error al cargar inventario de almacén', variant: 'destructive' });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDeleteAll = () => {
    startDeleteTransition(async () => {
      ...
      if (res.success) {
        toast({ title: 'Inventario de almacén vaciado' });
        loadSupplies();
      }
    });
  };
    ...
    <div className="space-y-6">
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="md:col-span-1">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Upload className="h-5 w-5" /> Cargar Almacén</CardTitle>
            <CardDescription>
              Actualiza el inventario de insumos mediante archivo Excel.
            </CardDescription>
          </CardHeader>
               ...
               <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button variant="destructive" size="sm" className="w-full" disabled={isDeleting || supplies.length === 0}>
                    <Trash2 className="h-4 w-4 mr-2" /> Vaciar Insumos
                  </Button>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Se eliminarán todos los registros de insumos. No se puede deshacer.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
        ...
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Resumen del estado de los insumos en almacén.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-muted/50 p-4 rounded-xl text-center">
                ...
                <div className="text-[10px] text-muted-foreground mt-1">Registros de almacén</div>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader className="pb-3 border-b">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <CardTitle>Listado de Insumos (Almacén)</CardTitle>
            ...
            <div className="overflow-x-auto">
              ...
              {filteredAndSortedSupplies.length > 300 && (
                <div className="p-4 text-center text-xs text-muted-foreground border-t italic">
                  Mostrando primeros 300 de {filteredAndSortedSupplies.length}.
                </div>
              )}
            </div>
          )}
