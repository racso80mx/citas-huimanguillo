...
import type { UltrasoundAppointment } from '@/lib/definitions';
...
export function UltrasoundAppointmentList({ appointments, isAdmin = false, onDelete }: UltrasoundAppointmentListProps) {
